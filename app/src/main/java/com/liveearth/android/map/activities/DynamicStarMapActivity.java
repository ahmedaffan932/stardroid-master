...
import com.liveearth.android.map.ApplicationConstants;
...
import com.liveearth.android.map.activities.util.ActivityLightLevelChanger;
import com.liveearth.android.map.activities.util.ActivityLightLevelManager;
import com.liveearth.android.map.activities.util.FullscreenControlsManager;
import com.liveearth.android.map.activities.util.GooglePlayServicesChecker;
import com.liveearth.android.map.base.Lists;
import com.liveearth.android.map.clasess.Misc;
import com.liveearth.android.map.control.AstronomerModel;
import com.liveearth.android.map.control.ControllerGroup;
import com.liveearth.android.map.control.MagneticDeclinationCalculatorSwitcher;
...
import com.liveearth.android.map.renderer.SkyRenderer;
import com.liveearth.android.map.renderer.util.AbstractUpdateClosure;
import com.liveearth.android.map.search.SearchResult;
import com.liveearth.android.map.touch.DragRotateZoomGestureDetector;
import com.liveearth.android.map.touch.GestureInterpreter;
import com.liveearth.android.map.touch.MapMover;
...
import com.liveearth.android.map.util.MathUtil;
import com.liveearth.android.map.util.MiscUtil;
import com.liveearth.android.map.util.SensorAccuracyMonitor;
import com.liveearth.android.map.views.ButtonLayerView;
...
//      Toast.makeText(DynamicStarMapActivity.this, " On Click", Toast.LENGTH_SHORT).show();
