...
import com.liveearth.android.map.control.AstronomerModelImpl;
import com.liveearth.android.map.control.MagneticDeclinationCalculator;
import com.liveearth.android.map.control.RealMagneticDeclinationCalculator;
import com.liveearth.android.map.control.ZeroMagneticDeclinationCalculator;
import com.liveearth.android.map.layers.EclipticLayer;
import com.liveearth.android.map.layers.GridLayer;
import com.liveearth.android.map.layers.HorizonLayer;
import com.liveearth.android.map.layers.LayerManager;
import com.liveearth.android.map.layers.MeteorShowerLayer;
import com.liveearth.android.map.layers.NewConstellationsLayer;
import com.liveearth.android.map.layers.NewMessierLayer;
import com.liveearth.android.map.layers.NewStarsLayer;
import com.liveearth.android.map.layers.PlanetsLayer;
import com.liveearth.android.map.layers.SkyGradientLayer;
